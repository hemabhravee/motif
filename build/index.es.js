...
process.env.NODE_ENV !== "production" ? ButtonBase.propTypes = {
   ...
   * @ignore
   */
  type: PropTypes__default.oneOfType([PropTypes__default.oneOf(['button', 'reset', 'submit']), PropTypes__default.string])
} : void 0;
...
var CustomButton = function () { return (React.createElement(Button$1, { variant: "contained", role: "button" }, "Click Here")); };
