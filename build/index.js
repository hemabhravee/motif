...
var elementTypeAcceptingRef$1 = chainPropTypes(PropTypes__namespace.elementType, elementTypeAcceptingRef);
...
process.env.NODE_ENV !== "production" ? StylesProvider.propTypes = {
   ...
   */
  disableGeneration: PropTypes__default['default'].bool,

  /**
   * JSS's class name generator.
   */
  generateClassName: PropTypes__default['default'].func,
   ...
   * JSS's instance.
   */
  jss: PropTypes__default['default'].object,

  /**
   * @ignore
   */
  serverGenerateClassName: PropTypes__default['default'].func,
   ...
   */
  sheetsCache: PropTypes__default['default'].object,
   ...
   */
  sheetsManager: PropTypes__default['default'].object,
   ...
   * Collect the sheets.
   */
  sheetsRegistry: PropTypes__default['default'].object
} : void 0;
...
var withStyles$1 = function withStyles(stylesOrCreator) {
  ...
  return function (Component) {
    ...
    process.env.NODE_ENV !== "production" ? WithStyles.propTypes = {
       ...
       * @deprecated
       */
      innerRef: chainPropTypes(PropTypes__default['default'].oneOfType([PropTypes__default['default'].func, PropTypes__default['default'].object]), function (props) {
...
process.env.NODE_ENV !== "production" ? Button.propTypes = {
   ...
   */
  color: PropTypes__default['default'].oneOf(['default', 'inherit', 'primary', 'secondary']),
   ...
   */
  size: PropTypes__default['default'].oneOf(['large', 'medium', 'small']),
   ...
   * The variant to use.
   */
  variant: PropTypes__default['default'].oneOf(['contained', 'outlined', 'text'])
} : void 0;
...
var CustomButton = function () { return (React__namespace.createElement(Button$1, { variant: "contained", role: "button" }, "Click Here")); };
